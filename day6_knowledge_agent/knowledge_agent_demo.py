...
def main() -> None:
    ...
    user_question = "如果我想学 Agent 开发，同时希望以后能接公司项目，应该优先补哪些工程基础？"
    ...
    tools = [
        {
            ...
            "function": {
                ...
                "description": "在本地知识库中检索与用户问题最相关的文本块",
                "parameters": {
                    "type": "object",
                    "properties": {
                        "query": {
    ...
    if not message.tool_calls:
        ...
        print("We can add a compatibility version if your proxy does not support tool calling.")
        return
    ...
    print("Final answer after knowledge retrieval:")
    print(final_text)
